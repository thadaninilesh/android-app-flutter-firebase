  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold (
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Sign Up', style: TextStyle(color: Colors.black.withOpacity(0.6))),
        actions: <Widget>[
          FlatButton.icon(onPressed: () {
            widget.toggleView();
          }, icon: Icon(Icons.person), label: Text('Sign In', style: TextStyle(color: Colors.black.withOpacity(0.6)),))
        ],
      ),
      body: Container(
